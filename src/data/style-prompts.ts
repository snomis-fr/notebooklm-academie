...
export interface StylePrompt {
  ...
  title: string;
  prompt: string;
  /** Chemin vers l'image du résultat (ex: /images/style-prompts/xxx.png) */
  image?: string;
  /** Variantes standard et détaillée (pour certains styles) */
  imageStandard?: string;
  imageDetailed?: string;
}
...
export const STYLE_PROMPTS: StylePrompt[] = [
  {
    ...
    image: "/images/style-prompts/equipe-de-france.png",
  },
  {
    id: 2,
    ...
    image: "/images/style-prompts/institutionnel-prestige.png",
  },
  {
    id: 3,
    title: "Olympic Gold",
    ...
    image: "/images/style-prompts/olympic-gold.png",
  },
  {
    id: 4,
    ...
    image: "/images/style-prompts/tech-tricolore.png",
  },
  {
    id: 5,
    ...
    image: "/images/style-prompts/minimalisme-diplomatique.png",
  },
  {
    id: 6,
    ...
    image: "/images/style-prompts/marine-nationale.png",
  },
  {
    id: 7,
    title: "Warm Tricolore",
    prompt: `Tons chaleureux dérivés du tricolore : bleu pervenche (#4A6FA5), rouge terracotta (#C0392B), crème (#FDF6E3) en fond. Titres en bleu, données en rouge, corps en gris foncé. L'élégance d'un magazine haut de gamme français. (Précise "détaillé" ou "standard" pour la densité du contenu.)`,
    imageStandard: "/images/style-prompts/warm-tricolore-standard.png",
    imageDetailed: "/images/style-prompts/warm-tricolore-detaille.png",
  },
  {
    id: 8,
    ...
    image: "/images/style-prompts/dashboard-decisionnel.png",
  },
  {
    id: 9,
    ...
    image: "/images/style-prompts/editorial-grand-recit.png",
  },
  {
    id: 10,
    title: "Nuit de Paris",
    ...
    image: "/images/style-prompts/nuit-de-paris.png",
  },
  {
    id: 11,
    ...
    image: "/images/style-prompts/infographie-pedagogique.png",
  },
  {
    id: 12,
  ...
  },
  {
    ...
    image: "/images/style-prompts/bleu-blanc-or-republicain.png",
  },
  {
    id: 15,
